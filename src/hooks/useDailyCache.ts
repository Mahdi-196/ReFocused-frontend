...
export const useContentCache = () => {
  ...
  const refreshContent = {
    quote: async () => {
      return fetch(`${base}/ai/quote-of-day`, { method: 'GET' }).then(res => res.json());
    },
    word: async () => {
      return fetch(`${base}/ai/word-of-day`, { method: 'GET' }).then(res => res.json());
    },
    mindFuel: async () => {
      return fetch(`${base}/ai/mind-fuel`, { method: 'GET' }).then(res => res.json());
    },
    all: async () => {
      await Promise.all([
        fetch(`${base}/ai/quote-of-day`, { method: 'GET' }),
        fetch(`${base}/ai/word-of-day`, { method: 'GET' }), 
        fetch(`${base}/ai/mind-fuel`, { method: 'GET' })
      ]);
    }
  };
