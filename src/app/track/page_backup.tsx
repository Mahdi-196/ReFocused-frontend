            ...
            <div className="container mx-auto px-4">
              ...
              <CalendarView
                ...
                onToggleHabit={async (dateStr: string, habitId: string, completed: boolean) => {
                  // Import markHabitCompletion from habitsService for explicit completion state
                  const { markHabitCompletion } = await import('@/services/habitsService');
                  await markHabitCompletion(parseInt(habitId), dateStr, completed);
                }}
                isHabitCompleted={isHabitCompleted}
              />
            </div>
