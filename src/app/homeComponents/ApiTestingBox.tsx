...
const ApiTestingBox = () => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200 w-full max-w-md mx-auto" style={{ minHeight: '300px', minWidth: '350px' }}>
      ...
      <button
        onClick={testApiCall}
        disabled={loading}
        className="w-full bg-blue-500 hover:bg-blue-600 disabled:bg-blue-300 text-white font-medium py-2 px-4 rounded-md transition duration-200 mb-4"
      >
